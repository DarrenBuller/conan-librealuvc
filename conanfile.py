...
class LibrealuvcConan(ConanFile):
    ...
    default_options = {"shared": True,
                       ...
                       "opencv:openexr": False # not needed and doesn't cross compile for android
                       } 
    exports = "LICENSE"
...
set(OpenCV_DIR "${CONAN_OPENCV_ROOT}/cmake")''')
            ...
            # Small hack might be useful to guarantee proper /MT /MD linkage
